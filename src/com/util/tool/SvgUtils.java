...
public class SvgUtils {
	 ...
	 * 
	 * @param context
	 *            Context object to get the resources.
	 * @param svgResource
	 *            int resource id of the svg.
	 */
	 ...
	 */
	public void drawSvgAfter(final Canvas canvas, final int width,
			final int height) {
	 ...
	 * 
	 * @param width
	 *            - the width to scale down the view to,
	 * @param height
	 *            - the height to scale down the view to,
	 ...
	 *            The height of the canvas.
	 * @param strokeWidth
	 *            Width of the path to add to scaling.
	 * @param canvas
	 *            The canvas to be drawn.
	 */
	...
	public static class SvgPath {
		 ...
		 * 
		 * @param path
		 *            The path that comes from the rendered svg.
		 * @param paint
		 *            The result paint.
		 */
		 ...
		 * 
		 * @param animationStepListener
		 *            AnimationStepListener.
		 */
		public void setAnimationStepListener(
				AnimationStepListener animationStepListener) {
