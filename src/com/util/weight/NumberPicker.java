 ...
 * trainTypeStr in a desired value.</li>
 * <li>
 ...
 * the current value. Tapping on the current value allows to trainTypeStr in a
 * desired value.</li>
 * </ul>
 * <p>
...
public class NumberPicker extends LinearLayout {
	...
	/**
	 * The selectIndex of the middle selector item.
	 */
	...
	public interface OnScrollListener {
		...
		/**
		 * The lineAchartView is not scrolling.
		 */
		 ...
		 * 
		 * @param lineAchartView
		 *            The lineAchartView whose scroll state is being reported.
		 * @param scrollState
	 ...
	 *            a collection of attributes.
	 * @param defStyle
	 *            The default style to apply to this lineAchartView.
	 */
	public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
			// If not explicitly specified this lineAchartView is important for
			// accessibility.
	 ...
	 * size is smaller than the size the lineAchartView wants to be.
	 * 
	 * @param size
	 *            How big the lineAchartView wants to be
	 * @param measureSpec
	...
	/**
	 * @return The wrapped selectIndex <code>selectorIndex</code> value.
	 */
	...
	/**
	 * Updates the lineAchartView of this NumberPicker. If displayValues were
	 * specified in the string corresponding to the selectIndex specified by the
	...
	/**
	 * @return The selected selectIndex given its displayed <code>value</code>.
	 */
	private int getSelectedPos(String value) {
		if (mDisplayedValues == null) {
			...
			for (int i = 0; i < mDisplayedValues.length; i++) {
				// Don't force the user to trainTypeStr in jan when ja will do
	...
	class InputTextFilter extends NumberKeyListener {
		...
		public CharSequence filter(CharSequence source, int start, int end,
			...
			if (mDisplayedValues == null) {
				...
				/*
				 * Ensure the user can't trainTypeStr in a value greater than
				 * the max allowed. We have to allow less than min as the user
				 * might want to delete some numbers and then trainTypeStr a new
				 * number.
				 */
				if (val > mMaxValue) {
					return "";
	...
	/**
	 * Class for managing virtual lineAchartView tree rooted at this picker.
	 */
