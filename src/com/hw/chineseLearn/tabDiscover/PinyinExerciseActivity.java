...
import com.hw.chineseLearn.tabMe.MySettingRemindersActivity;
import com.util.weight.MyHScrollView;
import com.util.weight.MyHScrollView.OnScrollChangedListener;
 ...
 * @author yh
 */
public class PinyinExerciseActivity extends BaseActivity {

	private String TAG = "==PinyinExerciseActivity==";
	...
	public void init() {
		...
		myAdapter = new MyAdapter(this, R.layout.layout_pinyin_item);
		...
		public void onClick(View arg0) {
			...
			case R.id.iv_title_left:// 返回
				...
				CustomApplication.app
						.finishActivity(PinyinExerciseActivity.this);
				break;
	...
	public class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parentView) {
			...
			if (convertView == null) {
				synchronized (PinyinExerciseActivity.this) {
