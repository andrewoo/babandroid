...
import ui.custom.pdgrid.PagedDragDropGridAdapter;
...
public class DragDropGridAdapter implements PagedDragDropGridAdapter {
	...
	public DragDropGridAdapter(Context ac, PagedDragDropGrid gv,
			ArrayList<TitleEntity> l, ServiceColumnAdapter at) {
		adapter = at;
		context = ac;
		gridview = gv;
		list = l;
	...
	private OnClickListener onClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Toast.makeText(context, "view" + v.getTag(), Toast.LENGTH_SHORT)
					.show();
			showDelColumnAnim(v);
		}
	};
