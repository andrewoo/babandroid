...
public class ReviewCharListAdapter extends BaseAdapter {
	private Context context;
	public ArrayList<LGCharacter> list;
	...
	public ReviewCharListAdapter(Context context, ArrayList<LGCharacter> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		LGCharacter model = list.get(position);
		if (model == null) {
			return convertView;
		}
