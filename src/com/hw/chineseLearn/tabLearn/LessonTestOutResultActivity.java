 ...
 * @author yh
 */
public class LessonTestOutResultActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		contentView = LayoutInflater.from(this).inflate(
				R.layout.activity_lesson_testout_result, null);
		...
		public void onClick(View arg0) {
			...
			case R.id.btn_redo:
				...
				CustomApplication.app
						.finishActivity(LessonTestOutResultActivity.this);
				break;
