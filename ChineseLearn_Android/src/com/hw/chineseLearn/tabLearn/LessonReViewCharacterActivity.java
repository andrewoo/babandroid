...
public class LessonReViewCharacterActivity extends BaseActivity {
    ...
    public void init() {
		...
		Drawable drawable = resources.getDrawable(R.drawable.mizige);
		Bitmap bitmap = BitmapLoader.drawableToBitmap(drawable);
		Bitmap bitmap1 = UtilMedthod.translateImageColor(bitmap,resources.getColor(R.color.chinese_skill_blue));
		Drawable drawable1 = new BitmapDrawable(bitmap1);
		rel_mizige.setBackgroundDrawable(drawable1);
