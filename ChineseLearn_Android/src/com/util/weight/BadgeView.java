...
public class BadgeView extends TextView {
	...
	public static final int POSITION_RIGHT_VERTICAL = 6;

	private static final int DEFAULT_MARGIN_DIP = 5;// mikes
	...
	private void init(Context context, View target, int tabIndex) {
		...
		setBackgroundResource(R.drawable.shape_unread);
...
//		int miniumWidth = getSuggestedMinimumWidth();
//		int miniumHeight = getSuggestedMinimumHeight();
//
//		int computedWidth = resolveMeasured(widthMeasureSpec, miniumWidth);
//		int computedHeight = resolveMeasured(heightMeasureSpec, miniumHeight);
//
...
//	}
	...
	private ShapeDrawable getDefaultBackground() {
		...
		int d = 10 * r;
		float[] outerR = new float[] { d, d, d, d, d, d, d, d };
	...
	private void applyLayoutParams() {
		...
		case POSITION_TOP_RIGHT:
			...
			lp.setMargins(0, 0, badgeMarginH * 4, 0);
			break;
